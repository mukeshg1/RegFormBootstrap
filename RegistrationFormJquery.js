/**
* File Name    : RegistrationFormJquery.js
* File Path    : C:\Users\mukeshg\Desktop\Internship\RegistrationFormJquery\jQuery
* Description  : Validation of HTML form and Showing of data in table and inline editing as well as editing in form
...
{	
    ...
    $(document).on('dblclick', 'td .row_data', function(event) 
    {
	...
	$(document).on('click', '#b_Update', function() 
	{
        ...
        var _about   = '<div class="row_data" edit_type="click" col_name="user_about">'+$("#about_user").val()+'</div>';
	...
	function check_phone()
	{
		...
		if (phone_number.length != 10){
			$("#phone_Error").html("Phone number should be of 10 digits.");
			$("#phone_Error").show();
			error_count = 1;
		}
		else 
	...
	function check_addr()
	{
		...
		{
			$("#user_addr_Error").html("Address cannot be empty");
